...
//        globalConfig.enableController();
        ...
        globalConfig.getPackageConfig()
                .setSourceDir(System.getProperty("user.dir") + "/trans-gateway/src/main/java")
                .setBasePackage("com.wybase.trans.gateway")
//                .setControllerPackage("com.wybase.trans.gateway.controller")
                .setServicePackage("com.wybase.trans.gateway.service")
                .setServiceImplPackage("com.wybase.trans.gateway.service.impl")
                .setEntityPackage("com.wybase.trans.gateway.model.entity.generate")
                .setMapperXmlPath(System.getProperty("user.dir") + "/trans-gateway/src/main/java/" + "com/wybase/trans/gateway/mapper/generate")
                .setMapperPackage("com.wybase.trans.gateway.mapper.generate");
...
//        tables.add("b_role_menu_relatn");
       tables.add("b_gateway_route");
       tables.add("b_gateway_route_param");
