      ...
      <el-table :data="sysLogList" style="width: 100%">
        ...
        <el-table-column align="center" label="交易类型" width="120">
          <template slot-scope="scope">
            <el-tag v-for="item in transType" :type="item.keyNm=='操作类' ?'warning':'success'"
      ...
      <el-dialog
        ...
        <el-form :inline="true" class="demo-form-inline" size="small" disabled>
          ...
          <el-form-item label="交易类型：" label-width="130px">
            ...
            <el-tag v-for="item in transType" style="width: 260px;" type="info"
          ...
          <el-form-item label="请求类路径：" label-width="130px">
            <el-input type="textarea" autosize v-model="sysLogInfo.classPath" style="width: 520px;"/>
          </el-form-item>
          <el-form-item label="请求参数：" label-width="130px">
            <el-input type="textarea" autosize v-model="sysLogInfo.params" style="width: 520px;"/>
          </el-form-item>
