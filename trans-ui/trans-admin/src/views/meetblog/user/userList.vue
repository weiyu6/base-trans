  ...
  <div class="app-container">
    ...
    <div>
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-form-item>
          <el-select clearable placeholder="用户标签" style="width:140px" v-model="searchObj.userTag">
            <el-option
        ...
        <el-form-item>
          <el-select clearable placeholder="评论状态" style="width:140px" v-model="searchObj.commentStat">
            <el-option
              :key="item.enumId+''+item.seq"
              :label="item.keyNm"
              :value="item.keyId"
        ...
        <el-button type="primary" icon="el-icon-search" @click="userInfoList()" v-permission="'/user/list'">查询 </el-button>
        <el-button type="primary" icon="el-icon-document-add" @click="openDialog" v-permission="'/user/add'">添加</el-button>
      </el-form>
    </div>
    <!-- 数据显示模块   -->
    <div>
      ...
      <el-table :data="userList" style="width: 100%"
        ...
        <el-table-column align="center" label="头像" width="100">
          <template slot-scope="scope">
            <img
              :src="scope.row.avatar" onerror="onerror=null;src=defaultAvatar"
        ...
        <el-table-column label="性别" align="center" width="80">
          ...
          <!--        </template>-->
          <template slot-scope="scope">
            <el-tag :key="item.enumId+''+item.seq" v-for="item in gender"
        ...
        <el-table-column align="center" label="评论状态" width="160">
          <template slot-scope="scope">
            <el-tag :key="item.enumId+''+item.seq" v-for="item in comment_stat"
        ...
        <el-table-column align="center" label="是否开启邮件通知" width="160">
          <template slot-scope="scope">
            <el-tag :key="item.enumId+''+item.seq" v-for="item in start_email_notice"
        ...
        <el-table-column fixed="right" align="center" label="操作" width="160">
          <template slot-scope="scope">
            <el-button type="primary" icon="el-icon-edit" size="mini" v-permission="'/user/mdf'"
                       @click="userByIdQry(scope.row.userId)"/>
            <el-tooltip class="item" effect="light" content="详情" placement="top">
              <el-button type="primary" icon="el-icon-info" size="mini" v-permission="'/user/info'"
    ...
    <div>
      <el-dialog
        ...
        <el-form :inline="true" class="demo-form-inline" size="small" :disabled="disabledflg">
          <el-form-item label="用户ID：" v-show="operFlg==='4'" label-width="130px">
            <el-input style="width: 260px" v-model="userinfoSig.userId"/>
          </el-form-item>
          <el-form-item label="用户名：" label-width="130px">
            <el-input style="width: 260px" v-model="userinfoSig.userNm"/>
          </el-form-item>

          <el-form-item label="密码：" v-show="operFlg=='2'" label-width="130px">
            <el-input style="width: 260px" v-model="userinfoSig.passWord"/>
          </el-form-item>
          <el-form-item label="昵称：" label-width="130px">
            <el-input style="width: 260px" v-model="userinfoSig.nickNm"/>
          </el-form-item>

          <el-form-item label="性别：" label-width="130px">
            <!--            <el-input v-model="userinfoSig.gender"/>-->
            <el-select clearable placeholder="性别" style="width:260px" v-model="userinfoSig.gender">
              <el-option
                :key="item.enumId+''+item.seq"
                :label="item.keyNm"
                :value="item.keyId"
          ...
          <el-form-item label="邮箱：" label-width="130px">
            <el-input style="width: 260px" v-model="userinfoSig.email"/>
          </el-form-item>

          <el-form-item label="手机号：" label-width="130px">
            <el-input style="width: 260px" v-model="userinfoSig.mobile"/>
          </el-form-item>
          <el-form-item label="QQ号：" label-width="130px">
            <el-input style="width: 260px" v-model="userinfoSig.qqNum"/>
          </el-form-item>
          <el-form-item label="微信号：" label-width="130px">
            <el-input style="width: 260px" v-model="userinfoSig.wechatNum"/>
          </el-form-item>
          <el-form-item label="职业：" label-width="130px">
            <!--            <el-input style="width: 260px" v-model="userinfoSig.profession"/>-->
            <el-select clearable placeholder="职业" style="width:260px"
          ...
          <!-- 只有后台注册修改的时候，才显示用户标签-->
          <el-form-item label="用户标签：" v-if="operFlg!='3'" label-width="130px">
            <!-- <el-input v-model="userinfoSig.userTag"/>-->
            <el-select clearable placeholder="用户标签" style="width:260px"
          ...
          <el-form-item label="用户角色：" v-if="operFlg!='3'" label-width="130px">
            <!-- <el-input v-model="userinfoSig.userTag"/>-->
          ...
          <el-form-item label="评论状态：" v-if="operFlg!='3'" label-width="130px">
            <!-- <el-input v-model="userinfoSig.userTag"/>-->
            <el-select clearable placeholder="用户标签" style="width:260px"
